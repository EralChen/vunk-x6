...
import { rMenus, rMenusWithButtons } from '@skzz-template/api/system/menu'
...
import { SkAppTablesV1 } from '@skzz-template/components/app-tables-v1'
import { setData, unsetData, VkDuplexCalc, VkDuplex, Media } from '@vunk/core'
import { Row } from './types'
import { SkAppQueryForm } from '@skzz-template/components/app-query-form'
import { __SkAppForm } from '@skzz-template/shared'
import { VkfCheckbox } from '@vunk/form/components/checkbox'
import { rButtons } from '@skzz-template/api/system/button'
